    ...
    internal class ModEntry : Mod
    {
        ...
        private void FindLadders()
        {
            ...
            for (var y = 0; y < layerHeight; y++)
            {
                ...
                if (!ladderHasSpawned && !Game1.mine.mustKillAllMonstersToAdvance() &&
                    (netStonesLeftOnThisLevel == 0 || r.NextDouble() < chance) &&
                    Game1.mine.shouldCreateLadderOnThisLevel()) _ladderStones.Add(obj);
            }
        }
        ...
        private static void OnRenderedWorld(object sender, RenderedWorldEventArgs e)
        {
            ...
            foreach (var rect in _ladderStones.Select(obj =>
                new Rectangle((int) obj.getLocalPosition(Game1.uiViewport).X,
                    (int) obj.getLocalPosition(Game1.uiViewport).Y, 64, 64))) DrawRectangle(rect, Color.Lime);
        }
